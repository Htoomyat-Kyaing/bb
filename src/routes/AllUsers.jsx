  ...
  return (
    <div className="flex flex-col h-auto" style={{ width: "1146px" }}>
      <div className="flex items-center justify-evenly">
        <div className="flex items-center">
          <input
            ...
            className="px-3 border rounded-md h-11"
            style={{ width: "300px" }}
          />
          <button
            type="submit"
        ...
        <div className="flex items-center justify-evenly">
          <span className="mr-5 text-lg text-white">Filter:</span>
          <Select
            name="role"
        ...
        <div className="flex items-center">
          <span className="mr-3 text-lg text-white">Items per page:</span>
          <Select
      ...
      <div className="flex flex-col items-center w-full mt-5">
        <table className="w-full h-auto overflow-hidden text-center rounded-lg shadow-lg">
          <thead>
        ...
        <div className="flex items-center justify-center mt-3">
          <div className="flex">
            {Array.from(
              {
                length: Math.ceil(
                  (status ? searchedData.length : userData.length) /
                    itemsPerPage
                ),
              },
              (_, index) => (
