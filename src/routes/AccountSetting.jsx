...
export default function AccountSetting(props) {
  ...
  const handleSave = (e) => {
    ...
    if (
      formDatas.oldPassword &&
      formDatas.oldPassword !== hardcodedOldPassword &&
      formDatas.newPassword === formDatas.confirmPassword
    ) {
            ...
            >
              ...
              >
                <input
                  ...
                  type={
                    passwordVisibility[password.fieldName] ? "text" : "password"
                  }
